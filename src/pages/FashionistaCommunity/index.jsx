...
const FashionistaCommunityPage = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-outfit items-start justify-start mx-[auto] w-[100%]">
        ...
        <Button className="bg-teal_900 cursor-pointer font-bold leading-[normal] md:ml-[0] ml-[96px] mt-[62px] px-[15px] py-[10px] rounded-[7px] shadow-bs sm:text-[18px] md:text-[20px] text-[22px] text-center text-white_A700 w-[253px]">
          +
        </Button>
        <div className="flex items-center mt-[822px] w-[100%]">
          <footer className="bg-teal_900 flex items-center justify-center md:px-[20px] w-[100%]">
...
export default FashionistaCommunityPage;
