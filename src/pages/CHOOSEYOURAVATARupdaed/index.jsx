...
const CHOOSEYOURAVATARupdaedPage = () => {
    ...
    <>
      <div className="bg-white_A700 flex font-outfit items-center justify-start mx-[auto] w-[100%]">
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row gap-[43px] items-center justify-start max-w-[1280px] mt-[48px] mx-[auto] md:px-[20px] w-[100%]">
          ...
          <footer className="bg-teal_900 flex items-center justify-center mt-[132px] md:px-[20px] w-[100%]">
...
export default CHOOSEYOURAVATARupdaedPage;
