...
import { Img, Text, Button, Input, RatingBar, Line } from "components";
  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-outfit items-center justify-start mx-[auto] w-[100%]">
          ...
          <div className="absolute bottom-[0] h-[436px] inset-x-[0] mx-[auto] w-[100%]">
            <div className="h-[436px] m-[auto] w-[100%]">
              ...
              <div className="absolute bg-white_A700 bottom-[0] flex md:flex-col flex-row md:gap-[20px] inset-x-[0] items-start justify-end mx-[auto] pt-[26px] sm:px-[20px] px-[26px] w-[100%]">
                ...
                <Button className="cursor-pointer font-semibold leading-[normal] min-w-[113px] md:ml-[0] ml-[16px] outline outline-deep_orange_100 p-[10px] sm:text-[18px] md:text-[20px] text-[22px] text-center text-deep_orange_100 w-[auto]">
                  REWARD
                </Button>
        ...
        <div className="md:h-[223px] h-[227px] max-w-[1270px] mt-[69px] mx-[auto] md:px-[20px] relative w-[100%]">
          <div className="absolute bottom-[0] flex inset-x-[0] items-center justify-end mx-[auto] outline outline-deep_orange_100 p-[14px] shadow-bs w-[auto]">
            <Text
              className="font-normal mt-[106px] not-italic text-bluegray_400 text-left w-[auto]"
              as="h5"
              variant="h5"
            >
              Badges / reward is used to access community benefits like premium
              topics, unlimited notification per day, unlimited comments, access
              to new features, beta testing users.{" "}
            </Text>
          </div>
          <div className="absolute bg-teal_900 flex items-center justify-start left-[0] p-[12px] rounded-[10px] shadow-bs top-[0] w-[24%]">
            <div className="flex flex-col gap-[27px] items-center justify-start mt-[4px] md:w-[100%] w-[97%]">
              <div className="flex flex-row gap-[48px] items-center justify-start w-[100%]">
                <Text
                ...
                <Text
                  className="font-normal not-italic text-left text-white_A700"
                  as="h5"
                  variant="h5"
                >
                  Spend a minimum of 10
                  <br /> Hours on our platform
                </Text>
              </div>
              <div className="flex flex-row gap-[15px] items-end justify-between md:w-[100%] w-[96%]">
                <div className="h-[11px] mb-[5px] mt-[8px] overflow-hidden relative w-[auto]">
                  <div className="w-full h-full absolute bg-white_A700 rounded-[5px]"></div>
                  <div
                    className="h-full absolute bg-deep_orange_100  rounded-[5px]"
                    style={{ width: "51%" }}
                  ></div>
                </div>
                <RatingBar
          ...
          <div className="absolute bg-gray_200 flex items-center justify-start left-[26%] p-[12px] rounded-[10px] top-[0] w-[24%]">
            <div className="flex flex-col gap-[27px] items-center justify-start mt-[4px] md:w-[100%] w-[97%]">
              <div className="flex flex-row gap-[30px] items-center justify-start w-[100%]">
                <Text
                ...
                <Text
                  className="font-normal not-italic text-gray_400 text-left"
                  as="h5"
                  variant="h5"
                >
              ...
              <div className="flex flex-row gap-[15px] items-end justify-between md:w-[100%] w-[96%]">
                <div className="bg-white_A700 h-[11px] mb-[5px] mt-[8px] rounded-[5px] w-[68%]"></div>
                <RatingBar
                  className=""
                  value={1}
                  starCount={3}
          ...
          <div className="absolute bg-gray_200 flex items-center justify-start p-[12px] right-[26%] rounded-[10px] top-[0] w-[24%]">
            <div className="flex flex-col gap-[27px] items-center justify-start mt-[4px] md:w-[100%] w-[97%]">
              <div className="flex flex-row gap-[43px] items-center justify-start w-[100%]">
                <Text
                  className="font-bold text-gray_400 text-left w-[auto]"
                  as="h4"
                  variant="h4"
          ...
          <div className="absolute bg-gray_200 flex items-center justify-end p-[14px] right-[0] rounded-[10px] top-[0] w-[24%]">
            <div className="flex flex-col gap-[16px] items-start justify-start mt-[4px] md:w-[100%] w-[95%]">
              <div className="flex flex-row gap-[28px] items-start justify-start md:w-[100%] w-[84%]">
                <Text
                  className="font-bold mt-[5px] text-gray_400 text-left sm:w-[100%] w-[35%]"
                  as="h4"
                  variant="h4"
                >
                  Golden star
        ...
        <div className="flex items-center justify-start max-w-[1086px] mt-[74px] mx-[auto] outline outline-deep_orange_100 p-[2px] md:px-[20px] shadow-bs w-[100%]">
          <div className="flex flex-col gap-[8px] items-start justify-start mb-[44px] md:w-[100%] w-[97%]">
            <Text
            ...
            <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between md:ml-[0] ml-[3px] w-[100%]">
              <Text
                className="font-normal md:mt-[0] mt-[12px] not-italic text-left text-teal_900"
                as="h2"
                variant="h2"
              >
                Your donation is used to sponsor a fashion designer to be on the
                runway!
                <br />
                Help us to put a smile on an aspiring designer’s face today!
              </Text>
              <Button className="bg-teal_900 cursor-pointer font-bold leading-[normal] mb-[6px] px-[15px] py-[10px] rounded-[7px] shadow-bs sm:text-[18px] md:text-[20px] text-[22px] text-center text-white_A700 w-[253px]">
                Donate to Us
              </Button>
            </div>
          </div>
